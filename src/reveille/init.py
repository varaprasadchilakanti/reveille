...
# The contributor ranking is OFF by default, from 0.8.0 onwards. Uncommenting
# the line below turns it ON. Read the caveat in README.md first: the ranking
# measures the volume and regularity of commits, which is not contribution,
# productivity or value, and it must not be used to assess individuals.
# enabled = false
...
# the same mappings before aggregating contributor metrics, so that
# one person committing under several addresses is counted once
